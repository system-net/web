...
#PAINEL A INSTALAR
panel_v20 () {
wget https://raw.githubusercontent.com/system-net/web/main/update/v20update > /dev/null 2>&1; chmod +x install; ./install
}
panel_v20_2 () {
wget https://raw.githubusercontent.com/system-net/web/main/update/v20-5update > /dev/null 2>&1; chmod +x install; ./install
}
panel_v20_3 () {
wget https://raw.githubusercontent.com/system-net/web/main/update/v20henriqueupdate > /dev/null 2>&1; chmod +x install; ./install
}
panel_v20_4 () {
wget https://raw.githubusercontent.com/system-net/web/main/update/v20joaoupdate > /dev/null 2>&1; chmod +x install; ./install
}
#CLEAN FOLDER
clean_folder () {
echo ""
...
echo -e "$barra"
echo ""
echo -e "\033[1;31m[\033[1;36m01\033[1;31m] \033[1;37m• \033[1;33mPAINEL UPDATE V20       \033[1;31m(ANT) " 
echo -e "\033[1;31m[\033[1;36m02\033[1;31m] \033[1;37m• \033[1;33mPAINEL UPDATE V20-5     \033[1;31m(DAN) " 
echo -e "\033[1;31m[\033[1;36m03\033[1;31m] \033[1;37m• \033[1;33mPAINEL UPDATE V20 HENRIQUE       \033[1;31m(ANT) " 
echo -e "\033[1;31m[\033[1;36m04\033[1;31m] \033[1;37m• \033[1;33mPAINEL UPDATE V20 JOAO     \033[1;32m(NEW) "
